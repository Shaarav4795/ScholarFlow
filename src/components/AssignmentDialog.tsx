    ...
    <Dialog.Root open={props.open} onOpenChange={props.onOpenChange}>
      {props.usePortal !== false ? (
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 z-[99999] w-[min(92vw,67.6rem)] -translate-x-1/2 -translate-y-1/2 rounded-[2rem] border border-white/35 bg-ink-50/96 p-8 shadow-[0_30px_120px_rgba(22,23,19,0.32)] outline-none dark:border-ink-700 dark:bg-ink-800">
          ...
          >
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Field label="Priority">
                <select {...form.register('priority')} className={cn(inputClassName(false), 'pr-12 appearance-none')}>
              ...
              <Field label="Status">
                <select {...form.register('status')} className={cn(inputClassName(false), 'pr-12 appearance-none')}>
